...
export default function SecaoEmBreve({ titulo, nota }: { titulo: string; nota?: string }) {
  return (
    <div>
      ...
      <div className="mt-8 flex flex-col items-center justify-center gap-3 rounded-lg border border-dashed py-16 text-center">
        ...
        <p className="text-muted-foreground">{nota ?? 'Esta tela será construída em uma próxima etapa.'}</p>
      </div>
    </div>
  )
}
